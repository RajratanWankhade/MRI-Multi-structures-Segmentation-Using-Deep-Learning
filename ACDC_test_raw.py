...
parser.add_argument('--root_path', type=str, default=r'C:\Users\rajwn\Videos\Manus_Malaka\3DCardiac\data\ACDC\training', help='Name of Experiment')
...
def calculate_metric_percase(pred, gt):
    ...
    hd95 = metric.binary.hd(pred, gt, voxelspacing=(5, 1.34, 1.34))
...
def Inference(FLAGS):
    with open(r'C:\Users\rajwn\Videos\Manus_Malaka\3DCardiac\data\ACDC\test_raw.list.txt') as f:
    ...
    save_model_path = r'C:\Users\rajwn\Videos\Manus_Malaka\3DCardiac\model\supervised\ACDC_BCP_7_labeled\self_train\unet_best_model.pth'
